USE `lab_db_creation`;
INSERT INTO `lab_db_creation`.`Cars` (`ID`, `VIN`, `manufacturer`, `model`, `year`, `color`) 
...
INSERT INTO `lab_db_creation`.`Customers` (`ID`, `customerID`, `name`, `phone_number`, `email`, `address`, `city`, `state/province`, `country`, `zip/postal code`) 
VALUES (1, 10001, 'Pablo Picasso', '+34 636 17 63 82', 'ppicasso@gmail.com', 'Paseo de la Chopera, 14', 'Madrid', 'Madrid', 'Spain', '28045'),
...
INSERT INTO `lab_db_creation`.`Salespersons` (`ID`, `staffID`, `name`, `store`) 
...
INSERT INTO `lab_db_creation`.`invoices` (`ID`, `invoice_number`, `invoice_date`, `car`, `customer`, `salesperson`) 
